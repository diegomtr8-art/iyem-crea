export const inp = 'w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-700 dark:bg-zinc-800/50 focus:ring-2 focus:ring-[#6B1938]/20 focus:border-[#6B1938] transition-all text-slate-900 dark:text-white placeholder:text-slate-400 text-base bg-white min-h-[44px]';

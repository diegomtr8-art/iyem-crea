...
<template>
    <div :class="card">
        ...
        <div v-if="isOpen" class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div><label :class="lbl">C.P.</label><input v-model="datos.cp" type="text" maxlength="5" inputmode="numeric" autocomplete="postal-code" :class="inp" /></div>
            ...
            <div class="sm:col-span-2 pt-3 border-t border-slate-100 dark:border-zinc-800">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div><label :class="lbl">C.P.</label><input v-model="datos.referencia_cp" type="text" maxlength="5" inputmode="numeric" autocomplete="postal-code" :class="inp" /></div>
                </div>
            </div>
        </div>
    </div>
